...
public class Main {
     ...
     * y1 y2 y3 y4
     *
     * This method is also used to read what player is starting the game, which is denoted by a 0 or 1.
    ...
    private static void readInput() {
        ...
        //wrong, what if it is golds turn?
    ...
    *
    * Not used in the python enviornment
    *
    * Used in our GUI enviornment
    * */
